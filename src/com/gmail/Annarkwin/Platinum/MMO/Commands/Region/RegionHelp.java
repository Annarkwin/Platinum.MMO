...
public class RegionHelp implements Subcommand , HelpCommand
{

	private String description = "Show region command help";
	private MainCommand main;
	private String name = "help";
	private String permission = "platinum.region.help";
	private boolean playeronly = true;
	private String usage = "/region help";

	public RegionHelp( MainCommand maincommand )
	{
	...
	public void run( CommandSender sender, String[] args )
	{
		...
		if (args.length > 1)
		{
			...
			if (CommandHelper.isPositiveInt(args[1]))
			{
				...
				CommandHelper.sendHelp(sender, entries, "Region", CommandHelper.getInt(args[1]));
