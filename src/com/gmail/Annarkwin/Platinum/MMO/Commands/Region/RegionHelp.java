...
public class RegionHelp extends PlatinumCommand implements HelpCommand
{

	public RegionHelp( String name, String permission, boolean player, String description, String usage )
	{
