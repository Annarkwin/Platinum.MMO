...
public class CommandInventory extends PlatinumMainCommand
{

	public CommandInventory( String name, String permission, boolean player, String description, String usage )
	{
