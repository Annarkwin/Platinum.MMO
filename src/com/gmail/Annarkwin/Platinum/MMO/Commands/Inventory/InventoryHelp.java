...
public class InventoryHelp implements Subcommand , HelpCommand
{

	private String description = "Show Inventory command help";
	private MainCommand main;
	private String name = "help";
	private String permission = "platinum.inventory.help";
	private boolean playeronly = true;
	private String usage = "/inventory help";

	public InventoryHelp( MainCommand maincommand )
	{
	...
	public void run( CommandSender sender, String[] args )
	{
		...
		if (args.length > 1)
		{
			...
			if (CommandHelper.isPositiveInt(args[1]))
			{
				...
				CommandHelper.sendHelp(sender, entries, "inventory", CommandHelper.getInt(args[1]));
		...
		else
		{
			...
			CommandHelper.sendHelp(sender, entries, "inventory", 1);
