...
public class InventoryHelp extends PlatinumCommand implements HelpCommand
{

	public InventoryHelp( String name, String permission, boolean player, String description, String usage )
	{
