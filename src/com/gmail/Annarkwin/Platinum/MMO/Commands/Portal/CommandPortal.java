...
public class CommandPortal implements CommandExecutor , MainCommand
{
	...
	{
			new PortalDisable(this), new PortalEnable(this), new PortalHelp(this), new PortalHook(this),
			new PortalInfo(this), new PortalList(this), new PortalNew(this), new PortalRemove(this),
			new PortalSetWarp(this), new PortalUnhook(this)
	};
