...
public class CommandPortal extends PlatinumMainCommand
{

	public CommandPortal( String name, String permission, boolean player, String description, String usage )
	{
