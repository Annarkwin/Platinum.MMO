...
public class PortalHelp implements Subcommand, HelpCommand {

	private String description = "Show portal command help";
	private MainCommand main;
	private String name = "help";
	private String permission = "platinum.portal.help";
	private boolean playeronly = true;
	private String usage = "/portal help";

	public PortalHelp(MainCommand maincommand) {
		main = maincommand;
	}
	...
	public void run(CommandSender sender, String[] args) {
		...
		if (args.length > 1) {
			if (CommandHelper.isPositiveInt(args[1])) {
				CommandHelper.sendHelp(sender, entries, "Portal", CommandHelper.getInt(args[1]));
			} else {
