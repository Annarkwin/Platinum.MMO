...
public class PortalHelp extends PlatinumCommand implements HelpCommand
{

	public PortalHelp( String name, String permission, boolean player, String description, String usage )
	{
