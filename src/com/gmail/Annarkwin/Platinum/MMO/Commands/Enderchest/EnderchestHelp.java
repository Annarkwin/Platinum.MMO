...
public class EnderchestHelp implements Subcommand, HelpCommand {

	private String description = "Show Enderchest command help";
	private MainCommand main;
	private String name = "help";
	private String permission = "platinum.enderchest.help";
	private boolean playeronly = true;
	private String usage = "/enderchest help";

	public EnderchestHelp(MainCommand maincommand) {
		main = maincommand;
	}
	...
	public void run(CommandSender sender, String[] args) {
		...
		if (args.length > 1) {
			if (CommandHelper.isPositiveInt(args[1])) {
				CommandHelper.sendHelp(sender, entries, "enderchest", CommandHelper.getInt(args[1]));
			} else {
