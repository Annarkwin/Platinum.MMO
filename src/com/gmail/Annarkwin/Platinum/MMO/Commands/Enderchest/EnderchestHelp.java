...
public class EnderchestHelp extends PlatinumCommand implements HelpCommand
{

	public EnderchestHelp( String name, String permission, boolean player, String description, String usage )
	{
