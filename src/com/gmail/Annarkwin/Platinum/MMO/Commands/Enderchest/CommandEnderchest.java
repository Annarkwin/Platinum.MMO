...
public class CommandEnderchest extends PlatinumMainCommand
{

	public CommandEnderchest( String name, String permission, boolean player, String description, String usage )
	{
