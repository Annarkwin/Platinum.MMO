...
public class CommandEnderchest implements CommandExecutor, MainCommand {

	private final Subcommand[] subcommands = {new EnderchestHelp(this), new EnderchestDrop(this), new EnderchestOpen(this), new EnderchestClear(this)};
