...
public class WarpHelp implements Subcommand, HelpCommand {

	private String description = "Show warp command help";
	private MainCommand main;
	private String name = "help";
	private String permission = "platinum.warp.help";
	private boolean playeronly = true;
	private String usage = "/warp help";

	public WarpHelp(MainCommand maincommand) {
		main = maincommand;
	}
	...
	public void run(CommandSender sender, String[] args) {
		...
		if (args.length > 1) {
			if (CommandHelper.isPositiveInt(args[1])) {
				CommandHelper.sendHelp(sender, entries, "Warp", CommandHelper.getInt(args[1]));
			} else {
