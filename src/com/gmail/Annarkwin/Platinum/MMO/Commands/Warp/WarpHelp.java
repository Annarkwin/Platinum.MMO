...
public class WarpHelp extends PlatinumCommand implements HelpCommand
{

	public WarpHelp( String name, String permission, boolean player, String description, String usage )
	{
