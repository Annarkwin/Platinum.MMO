...
public class CommandWarp implements CommandExecutor , MainCommand
{
	...
	{
			new WarpDisable(this), new WarpEnable(this), new WarpGo(this), new WarpHelp(this), new WarpHook(this),
			new WarpInfo(this), new WarpList(this), new WarpNew(this), new WarpRemove(this), new WarpSetWarp(this),
			new WarpUnhook(this)
	};
