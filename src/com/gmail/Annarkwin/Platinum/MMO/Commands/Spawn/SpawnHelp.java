...
public class SpawnHelp extends PlatinumCommand implements HelpCommand
{

	public SpawnHelp( String name, String permission, boolean player, String description, String usage )
	{
