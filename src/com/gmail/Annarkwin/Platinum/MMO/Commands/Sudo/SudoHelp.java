...
public class SudoHelp extends PlatinumCommand implements HelpCommand
{

	public SudoHelp( String name, String permission, boolean player, String description, String usage )
	{
