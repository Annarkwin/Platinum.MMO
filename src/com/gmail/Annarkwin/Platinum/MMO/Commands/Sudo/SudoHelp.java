...
public class SudoHelp implements Subcommand , HelpCommand
{

	private String description = "Show Sudo command help";
	private MainCommand main;
	private String name = "help";
	private String permission = "platinum.sudo.help";
	private boolean playeronly = true;
	private String usage = "/sudo help";

	public SudoHelp( MainCommand maincommand )
	{
	...
	public void run( CommandSender sender, String[] args )
	{
		...
		if (args.length > 1)
		{
			...
			if (CommandHelper.isPositiveInt(args[1]))
			{
				...
				CommandHelper.sendHelp(sender, entries, "sudo", CommandHelper.getInt(args[1]));
