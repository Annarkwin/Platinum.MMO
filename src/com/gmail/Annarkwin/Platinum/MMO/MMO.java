...
public class MMO extends JavaPlugin
{
	...
	{
		PlatinumMainCommand afk = new CommandAFK("afk", "platinum.command.afk", true, "Set your afk status", "/afk help (page)");
		...
		PlatinumMainCommand enderchest = new CommandEnderchest("enderchest", "platinum.command.enderchest", true, "Control enderchests", "/enderchest help (page)");
		enderchest.addChildCommand(new EnderchestClear("clear", "platinum.command.enderchest.clear", true, "Clear enderchest contents", "/enderchest clear (player)"));
		enderchest.addChildCommand(new EnderchestDrop("drop", "platinum.command.enderchest.drop", true, "Drop enderchest contents", "/enderchest drop (player)"));
		enderchest.addChildCommand(new EnderchestHelp("help", "platinum.command.enderchest.help", true, "Show enderchest help", "/enderchest help (page)"));
		enderchest.addChildCommand(new EnderchestOpen("open", "platinum.command.enderchest.open", true, "Open an enderchest", "/enderchest open (player)"));
		getCommand("Enderchest").setExecutor(enderchest);
		
		PlatinumMainCommand inventory = new CommandInventory("inventory", "platinum.command.inventory", true, "Control inventories", "/inventory help (page)");
		inventory.addChildCommand(new InventoryClear("clear", "platinum.command.inventory.clear", true, "Clear inventory contents", "/inventory clear (player)"));
		inventory.addChildCommand(new InventoryCopy("copy", "platinum.command.inventory.copy", true, "Copy inventory contents", "/inventory copy <player>"));
		inventory.addChildCommand(new InventoryDrop("drop", "platinum.command.inventory.drop", true, "Drop inventory contents", "/inventory drop (player)"));
		inventory.addChildCommand(new InventoryHelp("help", "platinum.command.inventory.help", true, "Show inventory help", "/inventory help (page)"));
		inventory.addChildCommand(new InventoryOpen("open", "platinum.command.inventory.open", true, "Open an inventory", "/inventory open (player)"));
		getCommand("Inventory").setExecutor(inventory);
		
		PlatinumMainCommand portal = new CommandPortal("portal", "platinum.command.portal", true, "Control portals", "/portal help (page)");
		portal.addChildCommand(new PortalDisable("disable", "platinum.command.portal.disable", true, "Disable a portal", "/portal disable <portal>"));
		portal.addChildCommand(new PortalEnable("enable", "platinum.command.portal.enable", true, "Enable a portal", "/portal enable <portal>"));
		portal.addChildCommand(new PortalHelp("help", "platinum.command.portal.help", true, "Show portal help", "/portal help (page)"));
		portal.addChildCommand(new PortalHook("hook", "platinum.command.portal.hook", true, "Set portal permission", "/portal hook <portal> <hook>"));
		portal.addChildCommand(new PortalInfo("info", "platinum.command.portal.info", true, "Get info of a portal", "/portal info <portal>"));
		portal.addChildCommand(new PortalList("list", "platinum.command.portal.list", true, "List portals", "/portal list"));
		portal.addChildCommand(new PortalNew("new", "platinum.command.portal.new", true, "Create a portal", "/portal new <name> <warp>"));
		portal.addChildCommand(new PortalRemove("remove", "platinum.command.portal.remove", true, "Remove a portal", "/portal remove <portal>"));
		portal.addChildCommand(new PortalSetWarp("setwarp", "platinum.command.portal.setwarp", true, "Change a portal warp", "/portal setwarp <portal> <warp>"));
		portal.addChildCommand(new PortalUnhook("unhook", "platinum.command.portal.unhook", true, "Remove portal permission", "/portal unhook <portal>"));
		getCommand("Portal").setExecutor(portal);
		
		PlatinumMainCommand quarry = new CommandQuarry("quarry", "platinum.command.quarry", true, "Control quarries", "/quarry help (page)");
		quarry.addChildCommand(new QuarryCooldown("cooldown", "platinum.command.quarry.cooldown", true, "Set quarry refill time", "/quarry cooldown <quarry> <seconds>"));
		quarry.addChildCommand(new QuarryDisable("disable", "platinum.command.quarry.disable", true, "Disable a quarry", "/quarry disable <quarry>"));
		quarry.addChildCommand(new QuarryEnable("enable", "platinum.command.quarry.enable", true, "Enable a quarry", "/quarry enable <quarry>"));
		quarry.addChildCommand(new QuarryGo("go", "platinum.command.quarry.go", true, "Teleport to a quarry", "/quarry go <quarry>"));
		quarry.addChildCommand(new QuarryHelp("help", "platinum.command.quarry.help", true, "Show quarry help", "/quarry help (page)"));
		quarry.addChildCommand(new QuarryHook("hook", "platinum.command.quarry.hook", true, "Set quarry permission", "/quarry hook <quarry> <hook>"));
		quarry.addChildCommand(new QuarryInfo("info", "platinum.command.quarry.info", true, "Get info of a quarry", "/quarry info <quarry>"));
		quarry.addChildCommand(new QuarryList("list", "platinum.command.quarry.list", true, "List quarries", "/quarry list"));
		quarry.addChildCommand(new QuarryNew("new", "platinum.command.quarry.new", true, "Create a quarry", "/quarry new <name>"));
		quarry.addChildCommand(new QuarryRefill("refill", "platinum.command.quarry.refill", true, "Refill a quarry", "/quarry refill <quarry>"));
		quarry.addChildCommand(new QuarryRemove("remove", "platinum.command.quarry.remove", true, "Remove a quarry", "/quarry remove <quarry>"));
		quarry.addChildCommand(new QuarrySetBlock("setblock", "platinum.command.quarry.setblock", true, "Set quarry block", "/quarry setblock <quarry>"));
		quarry.addChildCommand(new QuarrySetTP("settp", "platinum.command.quarry.settp", true, "Set quarry tp", "/quarry settp <quarry>"));
		quarry.addChildCommand(new QuarryUnhook("unhook", "platinum.command.quarry.unhook", true, "Remove quarry permission", "/quarry unhook <quarry>"));
		getCommand("Quarry").setExecutor(quarry);
		
		PlatinumMainCommand region = new CommandRegion("region", "platinum.command.region", true, "Control regions", "/region help (page)");
		region.addChildCommand(new RegionAllow("allow", "platinum.command.region.allow", true, "Allow player to region", "/region allow <player>"));
		region.addChildCommand(new RegionAllowed("allowed", "platinum.command.region.allowed", true, "List allowed players", "/region allowed"));
		region.addChildCommand(new RegionAnimals("animals", "platinum.command.region.animals", true, "Toggle animal spawning", "/region animals"));
		region.addChildCommand(new RegionGive("give", "platinum.command.region.give", true, "Give region to player", "/region give <player>"));
		region.addChildCommand(new RegionGrow("grow", "platinum.command.region.grow", true, "Toggle block growth", "/region grow"));
		region.addChildCommand(new RegionHelp("help", "platinum.command.region.help", true, "Show region help", "/region help (page)"));
		region.addChildCommand(new RegionInfo("info", "platinum.command.region.info", true, "Get info of a region", "/region info"));
		region.addChildCommand(new RegionKick("kick", "platinum.command.region.kick", true, "Kick player from region", "/region kick <player>"));
		region.addChildCommand(new RegionLock("lock", "platinum.command.region.lock", true, "Lock region devices", "/region lock"));
		region.addChildCommand(new RegionMonsters("monsters", "platinum.command.region.monsters", true, "Toggle monster spawning", "/region monsters"));
		region.addChildCommand(new RegionNew("new", "platinum.command.region.new", true, "Create a region", "/region new"));
		region.addChildCommand(new RegionPublic("public", "platinum.command.region.public", true, "Toggle public breaking", "/region public"));
		region.addChildCommand(new RegionPVP("pvp", "platinum.command.region.pvp", true, "Toggle pvp", "/region pvp"));
		region.addChildCommand(new RegionRemove("remove", "platinum.command.region.remove", true, "Remove a region", "/region remove"));
		region.addChildCommand(new RegionSetWarp("setwarp", "platinum.command.region.setwarp", true, "Set region tp", "/region settp"));
		getCommand("Region").setExecutor(region);
		
		PlatinumMainCommand spawn = new CommandSpawn("spawn", "platinum.command.spawn", true, "TP to the spawn warp point", "/spawn help (page)");
		spawn.addChildCommand(new SpawnHelp("help", "platinum.command.spawn.help", true, "Show spawn help", "/spawn help (page)"));
		getCommand("Spawn").setExecutor(spawn);
		
		PlatinumMainCommand sudo = new CommandSudo("sudo", "platinum.command.sudo", true, "Force others to run commands", "/sudo help (page)");
		sudo.addChildCommand(new SudoHelp("help", "platinum.command.sudo.help", true, "Show sudo help", "/sudo help (page)"));
		sudo.addChildCommand(new SudoRun("run", "platinum.command.sudo.run", true, "Force others to run commands", "/sudo run <player> <command string>"));
		getCommand("Sudo").setExecutor(sudo);
		
		
		getCommand("Test").setExecutor(new CommandTest());
		
		PlatinumMainCommand warp = new CommandWarp("warp", "platinum.command.warp", true, "Warp to locations", "/warp help (page)");
		warp.addChildCommand(new WarpDisable("disable", "platinum.command.warp.disable", true, "Disable a warp", "/warp disable <warp>"));
		warp.addChildCommand(new WarpEnable("enable", "platinum.command.warp.enable", true, "Enable a warp", "/warp enable <warp>"));
		warp.addChildCommand(new WarpGo("go", "platinum.command.warp.go", true, "Warp to locations", "/warp go <warp>"));
		warp.addChildCommand(new WarpHelp("help", "platinum.command.warp.help", true, "Show warp help", "/warp help (page)"));
		warp.addChildCommand(new WarpHook("hook", "platinum.command.warp.hook", true, "Set warp permission", "/warp hook <warp> <hook>"));
		warp.addChildCommand(new WarpInfo("info", "platinum.command.warp.info", true, "Get warp info", "/warp info <warp>"));
		warp.addChildCommand(new WarpList("list", "platinum.command.warp.list", true, "List warps", "/warp list"));
		warp.addChildCommand(new WarpNew("new", "platinum.command.warp.new", true, "Create a warp", "/warp new <name>"));
		warp.addChildCommand(new WarpRemove("remove", "platinum.command.warp.remove", true, "Remove a warp", "/warp remove <warp>"));
		warp.addChildCommand(new WarpSetWarp("setwarp", "platinum.command.warp.setwarp", true, "Set a warp location", "/warp setwarp <warp>"));
		warp.addChildCommand(new WarpUnhook("unhook", "platinum.command.warp.unhook", true, "Remove warp permission", "/warp unhook <warp>"));
